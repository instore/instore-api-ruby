...
describe 'Instore::Api#order_lines' do
  ...
  it 'should fetch order_lines', vcr: {cassette_name: 'order_lines/index'} do
    response = subject.order_lines.fetch
    response.should be_instance_of(Instore::EndPoints::Mash)
  end

  it 'should fetch order_line', vcr: {cassette_name: 'order_lines/show'} do
    response = subject.order_lines.find('d9345047-1fa2-17e3-4178-5dace041ec83')
    response.status.should be_true
  end
  
  it 'should create order_line', vcr: {cassette_name: 'order_lines/create'} do
  ...
  it 'should destroy order_line', vcr: {cassette_name: 'order_lines/destroy'} do
