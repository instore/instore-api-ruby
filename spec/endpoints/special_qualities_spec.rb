...
describe 'Instore::Api#special_qualities' do
  ...
  it 'should fetch special_qualities', vcr: {cassette_name: 'special_qualities/index'} do
    response = subject.special_qualities.fetch
    response.should be_instance_of(Instore::EndPoints::Mash)
  end

  it 'should fetch special_quality', vcr: {cassette_name: 'special_qualities/show'} do
    response = subject.special_qualities.find('074bfaea-392d-5d4e-e495-aef5e4997a02')
    response.status.should be_true
  end
  
  it 'should create special_quality', vcr: {cassette_name: 'special_qualities/create'} do
  ...
  it 'should destroy special_quality', vcr: {cassette_name: 'special_qualities/destroy'} do
