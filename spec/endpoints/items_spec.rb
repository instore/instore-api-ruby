...
describe 'Instore::Api#items' do
  ...
  let(:item_category_id) { '1e36bfbc-d1a8-4cce-8073-add1c6a2f3d0' }

  it 'should fetch item' do
    VCR.use_cassette('items/show') do
      response = instore.items.find('a259f474-1dba-e53f-d88f-5925cdeb8085')
  ...
  it 'should create item' do
    VCR.use_cassette('items/create') do
      response = instore.items.create(location_id: location_id, item_category_id: '17b530c0-fd28-4091-94b0-aab2417936ae', name: 'Test item 13!')
      response.status.should be_true
    end
  end
  ...
  it 'should update item' do
    VCR.use_cassette('items/update') do
      response = instore.items.update('a259f474-1dba-e53f-d88f-5925cdeb8085', name: 'Test item 99!')
      response.status.should be_true
    end
  end
  ...
  it 'should destroy item' do
    VCR.use_cassette('items/destroy') do
      response = instore.items.destroy('a259f474-1dba-e53f-d88f-5925cdeb8085')
      response.status.should be_true
    end
  end
end