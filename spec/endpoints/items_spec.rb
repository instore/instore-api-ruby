...
describe 'Instore::Api#items' do
  ...
  it 'should create item' do
    VCR.use_cassette('items/create') do
      response = instore.items.create(location_id: '1e36bfbc-d1a8-4cce-8073-add1c6a2f3d0', item_category_id: '17b530c0-fd28-4091-94b0-aab2417936ae', name: 'Test item 13!')
      response.status.should be_true
    end
  end
