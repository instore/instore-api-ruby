...
describe 'Instore::Api#applied_discounts' do
  ...
  it 'should fetch applied_discounts', vcr: {cassette_name: 'applied_discounts/index'} do
    response = subject.applied_discounts.fetch
    response.should be_instance_of(Instore::EndPoints::Mash)
  end

  it 'should fetch applied_discount', vcr: {cassette_name: 'applied_discounts/show'} do
    response = subject.applied_discounts.find('672e580e-7607-6de2-3ed1-8e0c042e1cde')
    response.status.should be_true
  end
  
  it 'should create applied_discount', vcr: {cassette_name: 'applied_discounts/create'} do
  ...
  it 'should destroy applied_discount', vcr: {cassette_name: 'applied_discounts/destroy'} do
