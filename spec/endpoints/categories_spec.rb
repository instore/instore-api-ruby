...
describe 'Instore::Api#categories' do
  let(:instore) { Instore::Api.new('9JkAmIetQcJg_ZJ-w-GEU9EphBg=') }
  ...
  it 'should fetch category' do
    ...
    VCR.use_cassette('categories/show') do
      response = instore.categories.find('6511f34c-beea-0488-170c-82038ee1306f')
  ...
  it 'should create category' do
    VCR.use_cassette('categories/create') do
      response = instore.categories.create(location_id: location_id, name: 'Test!')
      response.status.should be_true
    end
  end
  ...
  it 'should fetch items for category' do
